                    ...
                    <div class="card">
                        <form action="/result/create" class="form-horizontal repeater" method="POST">
                            ...
                            <div class="card-content" data-repeater-list="student-units">
                                <div class="row">
                                    <label class="col-sm-2 label-on-left">Student Details</label>
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" name="admission_number"
                                                           placeholder="Admission Number" type="text">
                                                    <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input class="form-control" name="academic_year"
                                                           placeholder="Academic Year" type="text">
                                                    <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating is-empty">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" name="cumulative"
                                                           placeholder="Cumulative" type="text">
                                                    <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" name="recommendation"
                                                           placeholder="Recommendation" type="text">
                                                    <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" name="grade" placeholder="Grade"
                                                           type="text">
                                                    <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group label-floating is-empty">
                                                    <label class="control-label"></label>
                                                    <input class="form-control" name="cf" placeholder="Cf" type="text">
                                                    <span class="material-input"></span></div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group label-floating is-empty">
                            ...
                            <div class="col-lg-2">
                                <button type="button" data-repeater-create class="btn btn-primary">Add
                                    <div class="ripple-container"></div>
                                </button>
                            </div>
