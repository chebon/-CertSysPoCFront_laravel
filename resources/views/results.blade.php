...
<header class="header-transparent" id="header-main" >
            ...
            <div class="navbar-nav align-items-center">
                ...
                <div class="ml-auto">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/shop-cart.html"><i class="far fa-shopping-cart"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/login.html"><i class="far fa-user-circle"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <nav style="display: none" class="navbar navbar-main navbar-expand-lg navbar-sticky navbar-light bg-white" id="navbar-main">
        <div class="container">
            <a class="navbar-brand mr-lg-5" href="../index.html">
                <img alt="Image placeholder" src="../assets/img/brand/dark.png" style="height: 50px;">
            </a>
                    ...
                    <div class="card shadow zindex-100">
                        <div class="card-body px-md-5 py-5">
                            <div class="text-center mb-5">
                                <h6 class="h3">Create Results</h6>
                                <p class="text-muted mb-0">Results creation forms</p>
                            </div>
                            <span class="clearfix"></span>


                        <form action="/create/result" method="post">
                            <div role="form" class="row" style="margin: auto;">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-transparent">
                                        ...
                                        <input type="email" class="form-control" id="input-email" placeholder="fullname">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    <label class="form-control-label">Averages</label>
                                    <div class="input-group input-group-transparent">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-key"></i></span>
                                        </div>
                                        <input type="text" class="form-control" id="averages" placeholder="averages">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">Cumulative </label>
                                    <div class="input-group input-group-transparent">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-key"></i></span>
                                        </div>
                                        <input type="text" class="form-control" id="cumulative" placeholder="cumulative">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-transparent">
                                        ...
                                        <input type="text" class="form-control" id="admission_number" placeholder="admission number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-transparent">
                                        ...
                                        <input type="text" class="form-control" id="academic_year" placeholder="academic year">
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label class="form-control-label">Recommendation </label>
                                    <div class="input-group input-group-transparent">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-key"></i></span>
                                        </div>
                                        <input type="text" class="form-control" id="recommendation" placeholder="recommendation">
                                    </div>
                                </div>

                                <div class="items row" style="padding-left: 10px;" data-group="test">
                                    ...
                                    <div class="form-group col-md-5 col-lg-3">
                                        <label class="form-control-label">CF </label>
                                        <div class="input-group input-group-transparent">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="far fa-key"></i></span>
                                            </div>
                                            <input type="text" class="form-control"  placeholder="Cf">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="row align-items-center">
                                        <div class="col-sm-7">
                                            <button type="button" class="btn btn-default mb-3 mb-sm-0">Add Unit</button>
                                        </div>
                                    </div>
                                </div>
...
<footer class="footer footer-dark bg-gradient-primary" style="display: none">
    <div class="container">
        <div class="row pt-md">
...
<script type = "text/javascript" src = "../assets/js/repeater.js"></script>
